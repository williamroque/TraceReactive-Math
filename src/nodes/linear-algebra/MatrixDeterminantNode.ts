...
export class MatrixDeterminantNode extends BaseNode {
    readonly typeId = 'math-matrix-determinant';
    readonly displayName = 'Determinant';
    ...
    async evaluate(inputs: Record<string, any>): Promise<Record<string, any>> {
        ...
        try {
            ...
            console.error('Error in determinant operation:', e);
            return { 'Result': null };
        }
    }
}
