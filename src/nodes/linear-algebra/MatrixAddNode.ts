...
export class MatrixAddNode extends BaseNode {
    readonly typeId = 'math-matrix-add';
    readonly displayName = 'Add Matrices';
    ...
    async evaluate(inputs: Record<string, any>): Promise<Record<string, any>> {
        ...
        try {
            ...
            console.error('Error in matrix add operation:', e);
            return { 'Result': null };
        }
    }
}
